...
test('add collection', async ({ page }) => {
  ...
  */
  ...
  await page.locator("//div[@class='fieldset stripe-form test-gateway']").frameLocator("//div[@id='stripe-card-expiry']//iframe").locator('[placeholder="MM/YY"]').fill("0328");
  ...
  await page.waitForTimeout(3 * 1000);
  await page.locator("//div[@class='s-date-editor s-input s-input--suffix s-date-editor--datetime']//input[@type='text']").click();
  await page.waitForTimeout(3 * 1000);
